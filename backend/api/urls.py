...
urlpatterns = [
    ...
    path('users/me/avatar/', UserMeAvatarView.as_view(), name='avatar'),
    ...
    path('recipes/<int:id>/favorite/', FavoriteRecipeView.as_view(), name='favorite'),
    path('recipes/<int:id>/shopping_cart/', ShoppingCartView.as_view(), name='shopping_cart'),
    path('recipes/<int:id>/get-link/', GetRecipeLinkView.as_view(), name='get-recipe-link'),
